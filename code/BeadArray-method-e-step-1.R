...
grnchannel.unlogged <- new("illuminaChannel", transFun = greenChannelTransformGrnHulk, outlierFun = illuminaOutlierMethod, exprFun = function(x) median(x, na.rm = TRUE), varFun = function(x) mad(x, na.rm = TRUE), channelName = "G")
