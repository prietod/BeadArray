...
# Perform no background normalization, variance stabilizing transformation and quantile normalization
data.gene.norm <- normaliseIllumina(data.gene, transform = "vst", method = "quantile")
