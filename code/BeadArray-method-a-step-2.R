...
# In lumi
# Code from http://svn.bigcat.unimaas.nl/arrayanalysis/trunk/src/IlmnModule/ILMN_functions_processingQC.R
# Background normalization using normal-exponential convolution using negative controls (neqc)
# Log2 transformation
# Quantile normalization
...
# Following function is from http://svn.bigcat.unimaas.nl/arrayanalysis/trunk/src/IlmnModule/ILMN_functions_processingQC.R
...
# Log2 transformation
# Quantile normalization
data.gene.lumi.n <- neqc.normData(data.gene.lumi, getControlData(controlFile.lumi, sep = "\t"))
