...
# Perform no background normalization, variance stabilizing transformation and local regression (loess) normalization
data.gene.norm <- normaliseIllumina(data.gene, transform = "vst", method = "loess")
